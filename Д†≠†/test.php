...
<body>
  <div class="fixedmenu">
    <div id="logo"><img src="logo.jpg" width="10"></div>
    <div class="fixedmenumenu">
          <div class="dropdown">
            <button class="dropbutton"><a href="#">Mindful</a></button>
        </div>
          <div class="dropdown">
            <button class="dropbutton"><a href="#">For pupils</a></button>
            <div class="dropdown-content">
            <a href="#">Careeer test</a>
            <a href="#">Olympiades</a>
            <a href="#">Courses</a>
          ...
          <div class="dropdown">
            <button class="dropbutton"><a href="#">For Applicants</a></button>
            <div class="dropdown-content">
          ...
          <div class="dropdown">
            <button class="dropbutton"><a href="#">For students</a></button>
            <div class="dropdown-content">
        ...
        <a href="#">Contacts</a>
        <img src="user.png" width="40" style="margin-top:15px; margin-left:12px;">
    </div>
  </div>
  </br></br>
...
<p><strong>______</strong>
<p><strong>Man - Man</strong> - all professions related to working with people,
serving people,and communicating.
</br><strong>The object of work is:</strong> people, groups, collectives.
</br><strong>Professions of this type are related to:</strong>
...
most of the professions are related to the processing of information.</br>
<strong>The objects of labor are:</strong> conventional signs, ciphers, codes, tables, numbers,
